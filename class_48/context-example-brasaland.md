...
> Nota de uso: este archivo es un `CONTEXT-company.md` real de una empresa ficticia (Brasaland), aportado como ejemplo de referencia para esta clase. Se usa en `resume_01.md` para ilustrar cada decision con numeros concretos. No sustituye el `CONTEXT-company.md` real de ningun equipo: cada equipo debe usar el suyo.
